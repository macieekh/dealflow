...
class DealsControllerTest < ActionController::TestCase
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post :create, deal: { client: @deal.client, description: @deal.description, headline: @deal.headline, value: @deal.value }
    end
  ...
  test "should update deal" do
    patch :update, id: @deal, deal: { client: @deal.client, description: @deal.description, headline: @deal.headline, value: @deal.value }
    assert_redirected_to deal_path(assigns(:deal))
  end
